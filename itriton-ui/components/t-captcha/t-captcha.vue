	...
	<view class="t-captcha" v-if="isShow">
		<view class="t-captcha-wrap">
			<view class="t-captcha__content">
				...
				<image class="t-captcha__content-jigsaw" :src="jigsaw" mode="heightFix"
				 :style="{height: `${height}px`, left: `${this.x}px`}"></image>
			...
			<view class="t-captcha__footer" :style="_computedFooterStyle" @touchend="handleTouchend" 
				...
				<movable-area class="t-captcha__footer-movable-area" :style="{width: `${width}px`}" :animation="true">
					<movable-view :x="x" direction="horizontal" class="t-captcha__footer-icon" @change="changeMovableArea"
					 :style="{backgroundColor: _computedThemeColor }"></movable-view>
				</movable-area>
			</view>
		</view>
		<view class="t-captcha__extra" :style="{width: `${width+20}px`}" v-if="!isHideFooter">
			...
			<view class="t-captcha__extra-content" v-if="!$slots.footer">
				<view class="t-captcha__extra-left">
					<image class="t-captcha__extra-icon" src="./icon/del.png" @click="hide()"></image>
					<image class="t-captcha__extra-icon" src="./icon/refresh.png" @click="reset(true)"></image>
					<image class="t-captcha__extra-icon" src="./icon/info.png" @click="info()"></image>
				</view>
